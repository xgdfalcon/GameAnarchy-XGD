    ...
    public class MilestonesPatch : MilestonesExtensionBase {
        public override void OnRefreshMilestones() {
            ...
            if (GAMod.EnabledUnlockParklifeLandmarks) {
                ...
                UnlockBuildingsSet("UnlockParklifeLandmarks", new string[8]
                    { "Zoo Requirements 1", "City Arch", "Clock Tower", "Old Market Street", "Sea Fortress", "Observation Tower", "Statue Of Colossalus", "Chirpwick Castle",
                    }, "Requirements");
            }
